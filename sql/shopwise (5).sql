...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 05 août 2023 à 21:48
...
(7, 3, 'scrub', 'lorem lorem lorem ', 300, '1691176078.jpg');
...
INSERT INTO `stock` (`PRODUIT_ID`, `QUANTITE_EN_STOCK`, `ALERTE_DE_STOCK_BAS`, `EMAIL_ENTREPRISE`) VALUES
(1, 202, 10, NULL),
(2, 300, 10, 'berbery@gmail.com'),
(7, 100, 10, NULL);
